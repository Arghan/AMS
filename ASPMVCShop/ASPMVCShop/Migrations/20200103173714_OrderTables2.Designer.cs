...
namespace ASPMVCShop.Migrations
{
    ...
    [Migration("20200103173714_OrderTables2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPMVCShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("ASPMVCShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("ASPMVCShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("ASPMVCShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ASPMVCShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("ASPMVCShop.Models.OrderDetail", b =>
                {
                    b.HasOne("ASPMVCShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASPMVCShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ASPMVCShop.Models.Pie", b =>
                {
                    b.HasOne("ASPMVCShop.Models.Category", "Category")
                        .WithMany("Pies")
